...
class GoogleFormsHandler {
  ...
  async submitToGoogleAppsScript(formData) {
    try {
      ...
      const appsScriptUrl = '/api/submit-footer.php'; // TODO: Замените AKfycbxWu2KdWiLNapj5ywD2lSqkQLFF17so5jEyjLYXrrcnY-SUjjVPHsZuwohhRyfXjSd5 на реальный ID Google Apps Script
