...
const server = http.createServer(async (req, res) => {
    ...
    // 🔥 ЗАГЛУШКИ ДЛЯ СТРАНИЦ ОБЪЕКТОВ
    if (req.url === '/object.html' || req.url === '/objects-with-photos.html' || req.url.startsWith('/objects/')) {
        console.log('🛠️ Maintenance page served for:', req.url);
        res.writeHead(503, {
        ...
        res.end(`
            ...
            <head>
                <meta charset="UTF-8">
                <title>Раздел на обслуживании - Fattoria.by</title>
                <style>
                    body { font-family: Arial; text-align: center; padding: 50px; background: #f5f5f5; }
                    .message { background: white; padding: 40px; border-radius: 10px; max-width: 500px; margin: 0 auto; }
                </style>
            </head>
            <body>
                <div class="message">
                    <h1>🏗️ Раздел на обновлении</h1>
                    <p>Информация об объектах временно недоступна</p>
                    <p><strong>Контакты:</strong><br>📞 +375 (29) 638-00-53<br>✉️ anfattoriya@gmail.com</p>
    ...
    if (req.url === '/api/submit-form-universal-fixed-v2.php' && req.method === 'POST') {
        let body = '';
